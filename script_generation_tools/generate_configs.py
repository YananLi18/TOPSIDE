...
hyper_config_dict = {
                     # 'omniglot': hyper_config(num_samples_per_class_range=[1, 5],
                     ...
                     #                               num_classes_range=[5],
                     #                               num_filters=[48]),
                     'sneset': hyper_config(num_samples_per_class_range=[100, 1000],
                                            batch_size_range=[8],
                                            init_inner_loop_learning_rate_range=[0.1],
                                            num_classes_range=[5, 20],
                                            num_filters=[48])
                     }
    ...
    for experiment_dataset_name, hyper_config in hyper_config_dict.items():
        ...
        for named_config in named_configs:
            ...
            configs_list.append(config(experiment_name=experiment_name, dataset_name=experiment_dataset_name,
                                       ...
                                       target_samples_per_class=int(0.1 * named_config['num_samples_per_class']),
