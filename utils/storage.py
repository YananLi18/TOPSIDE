...
def build_experiment_folder(experiment_name, metric_name, loss_name, num_classes):
    experiment_path = os.path.abspath(experiment_name)
    saved_models_filepath = "{}/{}/{}/{}/{}".format(experiment_path, metric_name, loss_name, str(num_classes), "saved_models")
    logs_filepath = "{}/{}/{}/{}/{}".format(experiment_path, metric_name, loss_name, str(num_classes), "logs")
    samples_filepath = "{}/{}/{}/{}/{}".format(experiment_path, metric_name, loss_name, str(num_classes), "visual_outputs")
